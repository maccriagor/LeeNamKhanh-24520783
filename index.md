...
{% include button.html text="Github" icon="github" link="https://github.com/maccriagor" color="#0366d6" %} {% include button.html text="Facebook" link="https://www.facebook.com/khanh.naka/" color="#f68140" %} {% include button.html text="Twitter" icon="twitter" link="https://twitter.com/intent/tweet/?url=https://alembic.darn.es&text=Alembic%20-%20A%20Jekyll%20boilerplate%20theme&via=DavidDarnes" color="#0d94e7" %} {% include button.html text="tham khảo" link="https://www.youtube.com/watch?v=E9exmuXjzIQ" %}
